...
mystr=file.read() #读取英文二进制，
print(type(mystr))
print(mystr.decode("gb2312","ignore")) #二进制文本
file.close()
#读取，编码不正确报错，强行编码，忽略错误ignore
...
#print(type(mystr.encode("gbk")))
file.write(mystr.encode("gbk","ignore")) #write,只能写入二进制
file.close()

#不同的编码，会导致编码失败
#编码失败，某个编码的字符，其他的编码没有
#编码忽略错误，有点时候也能解码，有的时候完全乱码
