...
wangwang1=win32gui.FindWindow("TXGuiFoundation","QQ")
wangwang2=win32gui.FindWindow("WeChatLoginWndForPC","微信")
while True:
    SE = 0.0
    ...
    while SE - 3.1415926535 * 2 < 0.000001:
        ...
        newx = int(400 + 400 * math.cos(SE))
        newy = int(400 + 400 * math.sin(SE))
        win32gui.SetWindowPos(wangwang1,  # 操作记事本
                              win32con.HWND_TOPMOST,  # 最上方
                              newx,  # 位置x
                              newy,  # 位置y
                              300,  # 长度
    ...
    while SE - 3.1415926535 * 2 < 0.000001:
        ...
        newx = int(400 + 400 * math.cos(SE))
        newy = int(400 + 400 * math.sin(SE))
        win32gui.SetWindowPos(wangwang2,  # 操作记事本
                              win32con.HWND_TOPMOST,  # 最上方
                              newx,  # 位置x
                              newy,  # 位置y
                              300,  # 长度
